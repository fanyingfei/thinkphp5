                ...
                a.createMenu(function(c) {
                    ...
                    if (c(d)) {
                        var e = this,
                            ...
                            i = b("<div></div>");
                        i.append('<div class="color-label-standard">推荐颜色</div>');
                        b.each(g,
                            function(a, b) {
                                i.append(['<a href="#" class="color-item"', '    title="' + b + '" commandValue="' + a + '" ', '    style="background-color: ' + a + '" ', '></a>'].join(""))
                            }),
                ...
                a.createMenu(function(c) {
                    ...
                    if (c(e)) {
                        var f = this,
                            ...
                            j = b("<div></div>");
                        j.append('<div class="color-label-standard">推荐颜色</div>');
                        b.each(h,
                            function(a, b) {
                                j.append(['<a href="#" class="color-item"', '    title="' + b + '" commandValue="' + a + '" ', '    style="background-color: ' + a + '" ', '></a>'].join(""))
                            }),
                    ...
                    a.createMenu(function(d) {
                        ...
                        if (d(f)) {
                            ...
                            x.append(y).append('<span style="display:inline-block;margin-left:5px;">  ' + i.dynamicMap + "</span>"),
                                ...
                                m.onRender = function() {
                                    j === a.baiduMapAk && a.log("建议在配置中自定义百度地图的mapAk，否则可能影响地图功能，文档：" + a.docsite)
                                },
            ...
            b(function(a, b) {
                function c() {
                    if (! (a.userAgent.indexOf("MSIE 8") > 0 || window.hljs)) {
                        var b = document.createElement("script");
                        b.type = "text/javascript",
                            b.src = "/wangEditor/highlight.min.js",
                            document.body.appendChild(b)
                    }
                }
                a.createMenu(function(d) {
